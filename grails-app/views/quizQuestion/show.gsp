...
<table class="table table-bordered">
    ...
    <tr>
        <g:if test="${quizQuestion?.content || false}">
            <td><strong><g:message code="quizQuestion.content.label" default="Question"/></strong></td>
    ...
    <tr>
        <g:if test="${quizQuestion?.tags || false}">
            <td><strong><g:message code="question.tags.label" default="Tags"/></strong></td>

            <td><ul class="unstyled"><g:each in="${quizQuestion.tags}" var="t">
